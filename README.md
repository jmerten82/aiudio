...
- [ ] **Graph spine** — typed IR + eager executor + the node contract *(ADR-0009 + `docs/74`; G1 ✅ IR; G2 ✅ executor; G3 🔜 live end-to-end — in review; G4–G6 next)*
- [ ] First end-to-end: capture → trivial graph (gain/meter) → playback, live *(G3: live graph verified silently through the backend; audible passthrough in review)*
