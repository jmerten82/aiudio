...
| [75-m9-robustness-hardening.md](./75-m9-robustness-hardening.md) | **M9 implementation plan** — the last I/O milestone (hardening; not a Phase-0 gate) split into sub-milestones M9.1–M9.6: xrun/underrun policy, channel mapping/routing, boundary sample-rate conversion, device hot-plug, drift compensation, multi-device — with RT-safety notes, dependency graph, minimum-viable vs. full scope, testing approach, and ADRs to write. |
