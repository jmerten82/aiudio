...
- **Related:** `docs/theory/30-*` §1, `docs/theory/50-architecture-patterns.md` §4, ADR-0002, ADR-0006
...
Verified (`docs/theory/30-*`, ✓): mainstream PyTorch/TensorFlow are **unsafe on the audio
...
- `docs/theory/30-*` §1, `docs/theory/50-architecture-patterns.md` §4, RTNeural & ANIRA papers
